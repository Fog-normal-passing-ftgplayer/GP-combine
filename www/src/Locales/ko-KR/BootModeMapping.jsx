export default {
	...
	'gpio-input-mode-explanation': '<p>여러 프로필을 사용하지 않는 경우 <0>설정 페이지</0>의 부팅 입력 모드 옵션으로 충분할 것입니다.</p><p>이 화면에서는 컨트롤러를 연결할 때 GP-Combine의 입력 모드로 진입하기 위해 누르고 있어야 할 물리적 버튼(GPIO 핀)을 설정할 수 있습니다（프로필 변경 시 바뀔 수 있는 매핑된 버튼과는 다릅니다）.</p><p>각 입력 모드에 대해 시작 시 불러올 프로필을 선택할 수도 있습니다（선택 사항）.</p>',
