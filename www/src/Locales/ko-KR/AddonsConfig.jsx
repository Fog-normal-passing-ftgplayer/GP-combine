export default {
	'header-text': '애드-온 구성',
	'sub-header-text':
		'아래 양식을 통해 GP-Combine의 애드-온 옵션을 설정할 수 있습니다.',
	...
	'player-number-sub-header-text':
		'플레이어 번호가 활성화된 여러개의 GP-Combine 장치를 연결하는 경우에만 이 옵션을 활성화하십시오.',
	...
	'ps4-mode-sub-header-text':'어떠한 경우에도 GP-Combine에서는 다음의 파일을 제공하지 않습니다!!!',
	'ps4-mode-text':
