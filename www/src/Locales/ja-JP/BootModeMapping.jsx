export default {
	...
	'gpio-input-mode-explanation': '<p>複数のプロファイルを使用しない場合は、大抵の場合<0>設定ページ</0>の起動時入力モード設定で問題ありません。</p><p>この画面では、コントローラーを接続する際にGP-Combineの各入力モードに入るために押し続けるボタン（GPIOピン）を設定できます（プロファイル変更時に変わる可能性のある割り当てされたボタンとは異なります）。</p><p>各入力モードに対して、起動時に読み込むプロファイルを任意で選択することもできます。</p>',
