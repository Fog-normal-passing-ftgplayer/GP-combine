...
struct ApuEvent_t *ApuEventQueue = 0;   // PSRAM（EspNesAllocBuffers 分配）
int  cur_event;
WORD entertime;
...
BYTE *wave_buffers_flat = 0;   // PSRAM
#define wave_buffers ((BYTE (*)[735])wave_buffers_flat)      /* 44100 / 60 = 735 samples per sync */
